...
// Metadata now points at files in /public/ethernet-assets/
const sequenceMetadata = [
  {
    title: 'Model 1: Pure & Slotted ALOHA (`model1_aloha.py`)',
    scriptPath: 'ethernet-assets//model1_aloha.py',
    output: `Protocol: csma\nOffered load G = 0.050\nThroughput S = 0.049 pkts/unit time`,
    image: '/ethernet-assets/comprehensive.py.png'
  },
  {
    title: 'Model 2: TCP Handshake over Ethernet (`model2_tcp_handshake.py`)',
    scriptPath: 'ethernet-assets//model2_tcp_handshake.py',
    output: null,
    image: '/ethernet-assets/comprehensive1.py.png'
  },
  {
    title: 'Model 3: Acknowledged Data Transfer (`model3_acknowledged_transfer.py`)',
    scriptPath: 'ethernet-assets//model3_acknowledged_transfer.py',
    output: null,
    image: '/ethernet-assets/comprehensive2.py.png'
  },
  {
    title: 'Model 4: Contention Simulation with GIF Export (`model4_contention_gif.py`)',
    scriptPath: 'ethernet-assets//model4_contention_gif.py',
